...
# urldownloads = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=<database>&id=<uid_list>&rettype=<retrieval_type>&retmode=<retrieval_mode>"
...
term = "human muscle hypertrophy AND strength training AND weight lifting AND resistance training AND strength gains AND bicep AND cardio"
...
#sk-proj-uFrV5wTV7VLyBzss80nhT3BlbkFJsE1Mm7ID7mKlu6JwgxyL
...
prompt = "how should i train my bicep for hypertrophy, be very technical"
